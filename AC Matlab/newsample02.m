...
filename = sprintf('%s_turn_sinMir_VcontFreq_rot_lam30_C025_180hz.png',time);
saveas( gcf,fullfile('C:\Users\labuser\Documents\LC14\Allison_Repo\Behavior', filename),'png')
...
time = datestr(now, 'yyyy_mm_dd');
filename = sprintf('%s_walk_sinMir_VcontFreq_rot_lam30_C025_180hz.png',time);
saveas( gcf,fullfile('C:\Users\labuser\Documents\LC14\Allison_Repo\Behavior', filename),'png')
...
%         meanturn(ff,:) = mean(thisFlyMat(timeX>0 & timeX<0.5,21,1));
%     end
