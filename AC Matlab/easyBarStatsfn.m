...
text(0.1,yloc+0.25*yloc,num2str(pvals,3));

%% --- 08.30.21 edit ---
if pvals(3,1) < 0.05 && pvals(3,2) < 0.05
    sprintf(['significant value for Epoch ', num2str(specificEpoch)]) 
end
% ---
